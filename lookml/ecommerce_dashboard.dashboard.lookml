- dashboard: ecommerce_dashboard
  ...
  - title: Avg Days between 1st and 2nd Order
    name: Avg Days between 1st and 2nd Order
    model: analytics
    explore: orders
    type: single_value
    fields:
    ...
    custom_color: ''
    show_single_value_title: true
    single_value_title: Avg Days between 1st and 2nd Order
    show_comparison: false
    comparison_type: value
    comparison_reverse_colors: false
    show_comparison_label: true
  ...
  - title: Items Sold by Order Date
    name: Items Sold by Order Date
    model: analytics
    explore: orders
    type: looker_line
    fields:
  ...
  - title: Avg Items per Order
    ...
    custom_color: ''
    show_single_value_title: true
    single_value_title: Avg Items per Order
    show_comparison: false
    comparison_type: value
    comparison_reverse_colors: false
    show_comparison_label: true
  ...
  - title: AvgItems per Order by Order Date
    name: Avg Items per Order by Order Date
    model: analytics
    explore: orders
    type: looker_line
    fields:
  ...
  - title: Avg Lifetime Orders
    ...
    custom_color: ''
    show_single_value_title: true
    single_value_title: Avg Lifetime Orders
    show_comparison: false
    comparison_type: value
    comparison_reverse_colors: false
    show_comparison_label: true
  ...
  - title: Avg Customer Lifetime Revenue
    name: Avg Customer Lifetime Revenue
    model: analytics
    explore: orders
    type: single_value
    fields:
    ...
    custom_color: ''
    show_single_value_title: true
    single_value_title: Avg Customer Lifetime Revenue
    show_comparison: false
    comparison_type: value
    comparison_reverse_colors: false
    show_comparison_label: true
    ...
    - label: ''
      ...
      - id: customers.average_lifetime_completed_orders
        name: Avg Lifetime Completed Orders
  ...
  - title: Avg Lifetime Orders by Order Date
    name: Avg Lifetime Orders by Order Date
    model: analytics
    explore: orders
    type: looker_column
    fields:
  ...
  - title: Avg Customer Lifetime Revenue by Order Date
    name: Avg Customer Lifetime Revenue by Order Date
    model: analytics
    explore: orders
    type: looker_column
    fields:
  ...
  - title: Avg First 30-day LTR
    name: Avg First 30-day LTR
    model: analytics
    explore: orders
    type: single_value
    fields:
    ...
    custom_color: ''
    show_single_value_title: true
    single_value_title: Avg First 30-day LTR
    show_comparison: false
    comparison_type: value
    comparison_reverse_colors: false
    show_comparison_label: true
  ...
  - title: Average First 60-day LTR
    ...
    custom_color: ''
    show_single_value_title: true
    single_value_title: Avg First 60-day LTR
    show_comparison: false
    comparison_type: value
    comparison_reverse_colors: false
    show_comparison_label: true
  ...
  - title: Avg First 90-day LTR
    name: Avg First 90-day LTR
    model: analytics
    explore: orders
    type: single_value
    fields:
    ...
    custom_color: ''
    show_single_value_title: true
    single_value_title: Avg First 90-day LTR
    show_comparison: false
    comparison_type: value
    comparison_reverse_colors: false
    show_comparison_label: true
